...
if __name__ == '__main__':
    ...
    with open("Task1/output/people.csv", "w") as f:
    ...
    with open("Task1/output/activated.csv", "w") as f:
        f.write("id,x,y,first_name,last_name,age,email,occupation,home_city\n")
    ...
    with open("Task1/output/people_with_handshake_info.csv", "w") as f:
